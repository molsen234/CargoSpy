...
namespace CargoSpy
{
    ...
    public class UIFastList : UIComponent
    {
        ...
        public void Clear()
        {
            // Debug.Log("CargoSpy - UIFastList.Clear()");
        ...
        {
            // Debug.Log("CargoSpy - UIFastList.DisplayAt()");
            ...
            // Debug.Log("CargoSpy - UIFastList.DisplayAt() m_pos: "+m_pos.ToString());
            for (int i = 0; i < m_rows.m_size; i++)
            {
        ...
        public void Refresh()
        {
            // Debug.Log("CargoSpy - UIFastList.Refresh()");
            DisplayAt(m_pos);
        }
        #endregion
        ...
        {
            // Debug.Log("CargoSpy - UIFastList.Start()");
            base.Start();
        ...
        {
            // Debug.Log("CargoSpy - UIFastList.OnDestroy()");
            base.OnDestroy();
        ...
        {
            // Debug.Log("CargoSpy - UIFastList.OnRowClicked()");
        ...
        {
            // Debug.Log("CargoSpy - UIFastList.UpdateScrollbar()");
            if (m_rowsData == null || m_rowHeight <= 0) return;
        ...
        {
            // Debug.Log("CargoSpy - UIFastList.UpdateScrollPosition()");
            ...
            // string msg = "CargoSpy - UIFastList.UpdateScrollPosition() - m_scrollbar.value: " + pos.ToString();
            // Debug.Log(msg);
            m_lock = false;
        }
        ...
        {
            // Debug.Log("CargoSpy - UIFastList.SetupControls()");
            if (m_panel != null) return;
            // Debug.Log("CargoSpy - UIFastList.SetupControls() - Actual setup!!");
